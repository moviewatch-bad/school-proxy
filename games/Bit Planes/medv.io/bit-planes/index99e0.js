!function (M) {
    ...
    , function (M, j, t) {
        ...
        j.b = {
            ...
            groundhit: [new L(t(55), 30, 31), new L(t(56), 30, 31), new L(t(57), 30, 31), new L(t(58), 30, 31), new L(t(59), 30, 31), new L(t(60), 30, 31), new L(t(61), 30, 31), new L(t(62), 30, 31), new L(t(63), 30, 31), new L(t(64), 30, 31), new L(t(65), 30, 31), new L(t(66), 30, 31)],
            ...
            cow: new L(t(26), 66, 62, .3),
            cowRunning: [new L(t(73), 68, 59, .3), new L(t(74), 67, 62, .3), new L(t(75), 68, 65, .3), new L(t(76), 73, 59, .3)],
            cowDead: new L(t(77), 70, 40, .3),
            ui: {
                targetMark: new L(t(78), 16, 16),
                skull: new L(t(79), 16, 16)
            },
    ...
    , function (M, j, t) {
        ...
        var L, N = t(2), i = t(0), e = t(3), u = t(16);
        !function (M) {
            M[M.Left = 0] = "Left",
                M[M.Right = 1] = "Right"
        }(L || (L = {}));
    ...
    , function (M, j, t) {
        ...
        function D(M, j, t) {
            const L = (j, t = 0) => {
                for (let L = 0; L < j.members.length; L++) {
                    ...
                    let I = M.measureText(u.name);
                    M.fillStyle = "rgba(255, 255, 255, 0.3)",
                        Object(e.e)(M, 92, i - 1, I.width + 6, 25, 5),
                        M.fill(),
                        M.fillStyle = "rgb(82, 161, 255)",
                        M.fillText(u.name, 95, i + 1),
                        M.fillStyle = u.color,
                        M.fillText(u.name, 95, i)
                }
            }
                ;
            L(j, 10),
        ...
        function a(M, j) {
            M.textBaseline = "top",
                M.font = "20px monospace",
                M.fillStyle = "#454545",
                M.drawImage(N.b.cow.canvas, 10, 10, 20, 20),
        ...
        Object(e.c)(() => {
            T = Object(e.a)(".ammo-capacity"),
                A = Object(e.a)(".missile-capacity"),
                r = Object(e.a)(".thrust"),
                S = Object(e.a)(".thrust-level")
        }
        )
    }
    , function (M, j, t) {
        ...
        class a extends e {
            constructor(M) {
                super(),
                    ...
                    this.size = 0,
                    this.timeSinceFrameShown = Object(N.h)()
            }
        }
        class g extends e {
            constructor(M) {
        ...
        function y(M, j) {
            for (let t of M.particles) {
                ...
                t.velocity.x += i.m * e.x * j,
                    ...
                    t instanceof a && Object(N.h)() - t.timeSinceFrameShown >= t.frameDuration && (t.frame++,
                        t.timeSinceFrameShown = Object(N.h)(),
    ...
    , function (M, j, t) {
        ...
        class e extends L.a {
            ...
            updateParachute() {
                this.parachute && (this.parachute.move(Object(i.a)(this.position, Object(i.u)(this.velocity.x > 0 ? -1 : 1, -22))),
                    this.parachute.angle = this.velocity.x > 0 ? -i.m : i.m)
            }
        }
        class u extends L.a {
            constructor(M) {
    ...
    , function (M, j, t) {
        ...
        function n(M, j, t, L) {
            ...
            return setInterval(() => {
                ...
                let a = j.hasPlane();
                if (a)
                    e && (A(M, a, null !== (t = null == L ? void 0 : L.moreBullets) && void 0 !== t && t),
                        D.c.bullets++,
                        i()),
                        u && (a.thrust -= 2,
                            a.thrust < 0 && (a.thrust = 0),
                            i()),
                        I && (a.thrust += 2,
                            a.thrust > N.k && (a.thrust = N.k),
                            i()),
                ...
                document.addEventListener("keydown", N => {
                    var a;
                    if (t.thrustLevers.up.includes(N.code))
                        I = !0;
                    else if (t.thrustLevers.down.includes(N.code))
                        u = !0;
                    else if (t.elevator.up.includes(N.code))
                        y = !0;
                    else if (t.elevator.down.includes(N.code))
                        n = !0;
                    else if (N.code === t.fire)
                        e = !0;
                    else if (N.code === t.missile) {
                        let t = j.hasPlane();
                        t && (r(M, t, null !== (a = null == L ? void 0 : L.explodingMissiles) && void 0 !== a && a),
                            D.c.missiles++,
                            i())
                    } else {
                        if (N.code !== t.catapult)
                            return;
                        if (j.hasPlane())
                            S(M, j);
                        else {
        ...
        function o(M, j) {
            for (let t of M)
                t instanceof I.a ? c(t, j) : t instanceof e.a && T(t, j)
        }
        function c(M, j) {
            const t = Object(y.h)(M.velocity);
            let L = 1 - t / (N.l * N.d);
            t > N.l && (L = 1 - 1 / N.d),
                M.angle += L * N.e * M.elevator * j,
        ...
        function r(M, j, t = !1) {
            if (M.has(j)) {
                if (j.missiles > 0) {
                    ...
                    j.timeout(N.n, () => i.justDeployed = !1),
                        Object(L.a)(M, i, t),
                        M.add(i)
                }
    ...
    , function (M, j, t) {
        ...
        class e extends L.a {
            constructor(M) {
                super(N.b.bullet, Object(i.u)(1, 0), Object(i.u)(0, 1)),
                    this.source = M,
                    this.radius = 2.5,
                    this.circles = [{
                        v: Object(i.u)(0, 0),
    ...
    , function (M, j, t) {
        ...
        function g(M) {
            for (let j = 0; j < 120; j++) {
                ...
                let u = 1e3;
                t.position = Object(i.u)((u + M.width) * Math.random() - u / 2, e),
                    M.clouds.push(t)
            }
            for (let j = 0, t = 10; t < M.width;) {
                const e = new L.d(N.b.groundObjects[j++ % N.b.groundObjects.length]);
                e.position = Object(i.u)(t, M.ground - e.sprite.height + .5),
        ...
        function y(M) {
            function j() {
                let j = new u.a;
                j.move(Object(i.u)(Math.random() * M.width, M.ground - j.sprite.height / 2)),
                    I(M, j),
                    M.add(j)
            }
            for (let M = D.g; M >= 0; M--)
    ...
    , function (M, j, t) {
        ...
        class I extends L.a {
            constructor(M, j) {
                super(i.b.barn, Object(e.u)(1, 0), Object(e.u)(0, 1)),
                    this.radius = 100,
                    this.circles = [{
                        v: Object(e.u)(0, 50),
                        r: 90
    ...
    , function (M, j, t) {
        ...
        function g(M, j, t, L, g) {
            ...
            c < 0 ? c = 0 : (M.fillStyle = "#1f4752",
                M.fillRect(0, 0, j.width, c)),
                M.fillStyle = "#9be2fe",
            ...
            for (let N of t) {
                ...
                if (!(t + N.radius < 0 || t - N.radius > j.width)) {
                    if (M.save(),
                        D + N.radius < 0)
                        (N instanceof u.a || N instanceof e.a) && (M.translate(Math.floor(t), 3),
                            I.b.pointerUp.drawMiddle(M));
                    else if (D - N.radius > j.height)
                        (N instanceof u.a || N instanceof e.a) && (M.translate(Math.floor(t), j.height - 3),
                        ...
                        if (window.showVectors && (M.save(),
                            ...
                            M.stroke(),
                            M.restore()),
                            N instanceof e.a && N.thrust > 0 && (M.translate(10, 0),
                            ...
                            j = Object(a.t)(j, Object(a.e)(Object(a.i)(j), N.player.target.radius)),
                        ...
                        if (N instanceof u.a && void 0 !== N.pointTo) {
                            ...
                            j = Object(a.t)(j, Object(a.e)(Object(a.i)(j), N.pointTo.radius)),
            ...
            for (let L of t.particles) {
                ...
                M.save(),
                    ...
                    L instanceof N.f ? (M.rotate(L.angle),
                        ...
                        L.sprite.drawMiddle(M)) : L instanceof N.a ? L.sprites[L.frame].drawMiddle(M) : L instanceof N.b ? L.sprite.drawMiddle(M) : L instanceof N.c ? (M.globalAlpha = 1 - Math.min(1, Math.abs((Object(D.h)() - L.createdAt) / L.duration)),
        ...
        function y(M, j, t, L, N, i) {
            ...
            if (e < j.height) {
                M.save(),
                    M.globalAlpha = .4,
                    M.translate(-j.offsetX / N % L.width, e);
        ...
        function n(M, j, t, L, N) {
            ...
            M.moveTo(j, t),
                M.lineTo(L, N),
                M.lineTo(L - 10 * Math.cos(u - Math.PI / 6), N - 10 * Math.sin(u - Math.PI / 6)),
                M.moveTo(L, N),
                M.lineTo(L - 10 * Math.cos(u + Math.PI / 6), N - 10 * Math.sin(u + Math.PI / 6)),
                M.stroke()
        }
        ...
        function S(M, j) {
            ...
            if (j.landed)
                ...
                const t = j.angle;
                if (j.velocity.y < 40 && (t < a.p || Math.abs(2 * Math.PI - t) < a.n))
                    return void (j.landed = !0);
                M.delete(j),
                    Object(o.d)(M, j, !0),
                    M.onCrash(j),
                    j.player && Object(r.c)(j.player)
            }
        }
        function z(M, j) {
            M.delete(j),
        ...
        function s(M, j) {
            for (let { v: t, r: L } of M.circles)
                if (t = Object(a.a)(Object(a.r)(t, M.angle), M.position),
                    t.y + L >= j)
                    return !0;
            return !1
        }
            ...
            if (l(M.position, M.radius, j.position, j.radius))
                for (let { v: t, r: L } of M.circles) {
                    ...
                    for (let { v: M, r: N } of j.circles)
                        if (M = Object(a.a)(Object(a.r)(M, j.angle), j.position),
                            l(t, L, M, N))
                            return !0
                }
            return !1
        ...
        function d(M, j) {
            !function (M) {
                    ...
                    if (j.position.y + j.radius >= M.ground) {
                        ...
                        if (s(j, M.ground)) {
                            ...
                            j instanceof i.a && (j.landed = !0),
                                j instanceof T.b && (j.landed = !0,
                                    Object(a.h)(j.velocity) > 40 ? (Object(o.e)(M, j),
                                        Object(o.c)(M, j),
                                        M.onCrash(j),
                                        M.delete(j),
                                        j.player && Object(r.c)(j.player)) : j.parachute && (M.delete(j.parachute),
                                            j.parachute = void 0)),
                ...
                function t(j, t) {
                    var L, N, I, D;
                    if (j instanceof e.a && t instanceof e.a)
                        return Object(o.d)(M, j),
                            Object(o.d)(M, t),
                            M.delete(j),
                            M.delete(t),
                            !0;
                    if (j instanceof u.a && t instanceof e.a)
                        return (!t.justDeployed || t.source !== j) && ((!t.justDeployed || void 0 === (null === (L = t.source.player) || void 0 === L ? void 0 : L.team) || void 0 === (null === (N = j.player) || void 0 === N ? void 0 : N.team) || t.source.player.team !== j.player.team) && (z(M, j),
                            M.delete(t),
                            t.source.player && j.player && Object(r.d)(t.source.player, j.player, r.a),
                            !0));
                    if (j instanceof u.a && t instanceof i.a)
                        return (null === (I = j.player) || void 0 === I ? void 0 : I.isHuman) && A.c.cowKilled++,
                            M.onCowKill(t),
                            M.delete(t),
                            !0;
                    if (j instanceof e.a && t instanceof i.a)
                        return (null === (D = j.source.player) || void 0 === D ? void 0 : D.isHuman) && A.c.cowKilled++,
                            Object(o.d)(M, t),
                            M.onCowKill(t),
                            M.delete(j),
                            M.delete(t),
                            !0;
                    if (j instanceof T.a) {
                        if (t instanceof u.a && j.load.plane !== t)
                            return M.delete(j),
                ...
                for (let M = 0; M < L.length - 1; M++) {
                    ...
                    for (let t = M + 1; t < L.length; t++) {
                        ...
                        j.position = Object(a.a)(j.position, Object(a.e)(i, j.radius / 2)),
                            M.position = Object(a.a)(M.position, Object(a.e)(i, -M.radius / 2))
                    }
                }
                for (let t of M.bullets) {
                    for (let L of M.bodies)
                        x(t, L) && (L instanceof u.a && (L.life -= 1,
                            0 == L.life && (z(M, L),
                                t.source.player && L.player && Object(r.d)(t.source.player, L.player)),
                            M.bullets.delete(t)),
                            L instanceof e.a && (Object(o.d)(M, L),
                                M.delete(t),
                                M.delete(L)),
                            L instanceof i.a && ((null === (j = t.source.player) || void 0 === j ? void 0 : j.isHuman) && A.c.cowKilled++,
                                M.onCowKill(L),
                                M.delete(t),
                                M.delete(L)),
                            L instanceof T.a && (M.delete(L),
                    ...
                    for (let j of M.pilots)
                        x(t, j) && (M.onCrash(j),
                            ...
                            Object(o.b)(M, j),
                            Object(o.c)(M, j),
                            t.source.player && j.player && Object(r.d)(t.source.player, j.player))
                }
                ...
                for (let j of M.pilots)
                    for (let t of M.bodies)
                        x(j, t) && (t instanceof u.a && j.plane !== t && !t.landed && (M.onCrash(j),
                            M.delete(j),
                            Object(o.b)(M, j),
                            Object(o.c)(M, j),
                            t.player && j.player && Object(r.d)(t.player, j.player, r.b)),
                            t instanceof e.a && (Object(o.d)(M, t),
                                M.onCrash(j),
                                M.delete(j),
                                M.delete(t),
                                Object(o.b)(M, j),
            ...
            for (let t of M) {
                if (t.forward = Object(a.u)(Math.sin(-t.angle - Math.PI / 2), Math.cos(-t.angle - Math.PI / 2)),
                    t.normal = Object(a.u)(Math.sin(-t.angle + Math.PI), Math.cos(-t.angle + Math.PI)),
                    t instanceof e.a && (m(t, M),
                        t.thrust > 0 && Object(o.f)(M, t)),
                    t instanceof u.a && (h(t, M),
                        t.life < w.h && Object(o.g)(M, t)),
                ...
                t instanceof u.a && t.landed ? (0 === t.thrust ? t.velocity.x += -t.velocity.x / 2 * j : t.velocity.x += w.m * L.x * j,
                    t.angle = Math.PI / 8,
                    t.velocity.y = 0,
                    ...
                    t.position.y = M.ground - 7) : t instanceof i.a && t.landed ? (t.velocity.y = 0,
                        ...
                        t.previous.y = t.position.y,
                        t.position.x += w.m * t.velocity.x * j,
                        t.position.y = M.ground - t.sprite.height / 2) : t instanceof T.b && t.landed ? (t.velocity.y = 0,
                            t.velocity.x += w.m * L.x * j,
                            t.previous.x = t.position.x,
                            t.previous.y = t.position.y,
                            t.position.x += w.m * t.velocity.x * j,
                            t.position.y = M.ground - t.sprite.height / 2) : (t.velocity.x += w.m * L.x * j,
                                t.velocity.y += w.m * L.y * j,
                                t.previous.x = t.position.x,
                                t.previous.y = t.position.y,
                                t.position.x += w.m * t.velocity.x * j,
                                t.position.y += w.m * t.velocity.y * j),
        ...
        function h(M, j) {
            ...
            M.position.y < j.stratosphere && (i = Object(a.g)(),
                e = Object(a.g)(),
                u = Object(a.g)()),
                M.force = Object(a.a)(N, i, e, u)
        }
        function U(M) {
            const j = Object(a.h)(M.velocity)
                , t = Object(a.u)(0, M.mass * w.a);
            let L = Object(a.e)(Object(a.i)(Object(a.f)(M.velocity)), 2 ** (j - w.l));
            M.landed && (L = Object(a.u)(-M.velocity.x, 0)),
                M.parachute && (L = Object(a.e)(Object(a.i)(Object(a.f)(M.velocity)), j / 4),
                    M.updateParachute()),
    ...
    , function (M, j, t) {
                    ...
                    if (void 0 !== j.target)
                        if (M.has(j.target)) {
                            ...
                            if (Math.abs(L) > g.m && s(Math.sign(L) > 0 ? 1 : -1),
                                ...
                                return;
                            if (j.target instanceof D.a && L < g.o && I < 500 && Math.random() < i.missileChance && x(),
                                L < g.n && I < 400) {
                                let t = T(M, n, g.p);
                                t instanceof u.a && t.source === n && t.thrust > 0 || A(t, j.team) || Object(N.d)(M, n)
                            }
                            n.ammo <= 3 && Object(N.d)(M, n),
                                j.target instanceof u.a && 0 === j.target.thrust && l()
                        } else
                            l();
                    else {
        ...
        function T(M, j, t = g.n, L = 500, N = (M => M instanceof i.a)) {
            ...
            for (let L of M) {
                ...
                M < u && Math.abs(i) < t && (e = L,
                    u = M)
            }
            return e
        }
        function A(M, j) {
            return void 0 !== j && (!!(M instanceof D.a && M.player && M.player.team === j) || (!!(M instanceof D.a && M.team && M.team === j) || (!!(M instanceof u.a && M.source.player && M.source.player.team === j) || !!(M instanceof I.b && M.player && M.player.team === j))))
        }
    }
    , function (M, j, t) {
        "use strict";
    ...
    , function (M, j, t) {
        ...
        var L = t(3);
        const N = ["#f36a20", "#dbaf02", "#70ba01", "#49da9a", "#34bbe6", "#4380db", "#261fe6", "#d23be7", "#ff0786", "#ff7d78", "#ff9c0a", "#ffcc00", "#a8c545", "#00a885", "#6a4c93", "#8e44ad", "#2c3e50", "#f39c12", "#d35400", "#c0392b", "#2980b9", "#16a085", "#27ae60", "#8e44ad", "#244b8c", "#f39c12", "#d35400", "#c0392b"]
    ...
    , function (M, j, t) {
        ...
        function a(M, j, t = !1, a = !0) {
                    ...
                    if (void 0 !== j.target)
                        if (M.has(j.target)) {
                            ...
                            if (j.elevator = Math.sign(e) > 0 ? 1 : -1,
                                ...
                                for (let L = 0; L < t; L++) {
                                    ...
                                    setTimeout(() => {
                                        const L = Object(N.r)(j.forward, Object(N.j)(360 * i / t))
                                            , e = Object(u.d)(M, j);
                                        e.position = Object(N.a)(j.position, Object(N.e)(L, 160 * Math.random())),
                                            e.velocity = Object(N.a)(j.velocity, Object(N.e)(L, 60 * Math.random()))
                                    }
                                        , 220 * Math.random())
                                }
                                Object(u.d)(M, j),
                                ...
                                const L = 500;
                                for (let t = 0; t < L; t++) {
                                    if (j.source instanceof D.a)
                                        return;
                                    const i = new I.a(j.source)
                                        , e = Object(N.r)(j.forward, Object(N.j)(360 * t / L));
                                    i.position = Object(N.a)(j.position, Object(N.e)(e, j.radius + 5)),
                                        i.velocity = Object(N.a)(j.velocity, Object(N.e)(e, 220)),
                                        M.add(i)
                                }
                            }
                        } else
                        ...
                        for (let u of M)
                            if (u instanceof e.a) {
                                if (u === j.source)
                                    continue;
                                if (void 0 !== (null === (L = u.player) || void 0 === L ? void 0 : L.team) && void 0 !== (null === (a = j.source.player) || void 0 === a ? void 0 : a.team) && u.player.team === j.source.player.team)
                                    continue;
            ...
            a ? j.setTimeout(g, 500) : g(),
                j.target = void 0
        }
    }
    , function (M, j, t) {
        var L, N, i = {}, e = (L = function () {
        ...
        function x(M, j, t, L) {
            ...
            if (M.styleSheet)
                ...
                e[j] && M.removeChild(e[j]),
                    e.length ? M.insertBefore(i, e[j]) : M.appendChild(i)
            }
        }
        function l(M, j) {
            var t = j.css
        ...
        function C(M, j, t) {
            ...
            const L = function (M, j) {
                ...
                t.move(Object(A.a)(M.position, Object(A.e)(M.normal, 10))),
                    M.direction === z.b.Right ? (t.move(Object(A.a)(t.position, Object(A.e)(M.forward, 20))),
                        t.forward = Object(A.r)(t.forward, A.p),
                        t.normal = Object(A.r)(t.normal, A.p),
                        t.angle = A.p) : (t.move(Object(A.a)(t.position, Object(A.e)(M.forward, -20))),
                            t.forward = Object(A.r)(t.forward, A.k),
                            t.normal = Object(A.r)(t.normal, A.k),
                            t.angle = A.k);
                j && (t.forward = Object(A.r)(Object(A.c)(M.forward), j),
                    t.normal = Object(A.r)(Object(A.c)(M.normal), j),
                    t.angle = j);
                return t.velocity = Object(A.e)(M.normal, 20),
                    t.thrust = 8,
                    t
            }(j, t);
            j.timeout(u.n, () => L.justDeployed = !1),
                Object(l.a)(M, L, !1, !1),
                M.add(L)
        }
        Object(S.c)((function () {
            if (c.c.killed > 1 && c.c.deaths > 1 && c.c.cowKilled > 1) {
                document.querySelector(".stats").innerHTML = `\n        You fired <em>${c.c.bullets.toLocaleString()}</em> <i class="ammo"></i> bullets \n        and <em>${c.c.missiles.toLocaleString()}</em> <i class="missile"></i> missiles\n        and destroyed <i class="target"></i> <em>${c.c.killed.toLocaleString()}</em> planes,\n        and unfortunately died <i class="skull"></i> <em>${c.c.deaths.toLocaleString()}</em> times. <br>\n        Also inadvertently you killed <em>${c.c.cowKilled.toLocaleString()}</em> <img src="${t(26)}" alt="cow" style="height: 14px"> cows. \n    `
            }
            let M = document.getElementsByName("nickname")[0];
            M.value = Object(c.a)("nickname") || "",
                M.addEventListener("keyup", j => Object(c.b)("nickname", M.value));
            ...
            let l = function () {
                        ...
                        j.player && j.player.detach(),
                            setTimeout(() => {
                                ...
                                L.life = u.h,
                                    ...
                                    L.landed = !0,
                                    L.ammo = 0,
                                    L.move(Object(A.u)(M.width / 2 + (1200 * Math.random() - 600), M.ground)),
                                    t.control(L),
                                    M.add(L)
                            }
                                , 2e3)
                ...
                for (let t = 0; t < u.j; t++) {
                    ...
                    e.player = I,
                        ...
                        e.move(Object(A.u)(M.width * Math.random(), M.ground * Math.random())),
                        M.add(e),
                        I.disableAI = Object(L.a)(M, I)
                }
                const t = document.querySelector(".demo")
                    , [D, a] = Object(e.b)(1.25, t);
                let c = Object(I.a)(D, a, M, (j, t) => {
                        ...
                        M) {
                                            ...
                                            j.player && (j.player.detach(),
                                                setTimeout(() => {
                                                    ...
                                                    L.life = u.h,
                                                        L.ammo = L.maxAmmo = t.maxAmmo,
                                                        L.landed = !0,
                                                        L.move(Object(A.u)(M.width * Math.random(), M.ground)),
                                                        t.control(L),
                                                        M.add(L)
                                                }
                                                    , 2e3))
                                        ...
                                        j.player && (j.player.detach(),
                                            setTimeout(() => {
                                                ...
                                                N.life = u.h,
                                                    ...
                                                    N.landed = !0,
                                                    N.move(Object(A.u)(L.startingPosition, M.ground)),
                                                    t.control(N),
                                                    M.add(N)
                                            }
                                                , 6e3))
                            ...
                            case "survival":
                                !function () {
                                    ...
                                    let S, z = parseInt(t.get("size") || "2"), s = Object(N.b)(), x = new n.b("#ff0015"), l = new y.a(x.color), w = new n.a(Object(c.a)("nickname") || "YOU", x.color, l);
                                    w.join(x),
                                        w.isHuman = !0,
                                        w.control(l),
                                        M.players.push(w),
                            ...
                            case "revenge":
                                !function () {
                                    ...
                                    for (let t = u.g; t >= 0; t--) {
                                        ...
                                        t.player = L,
                                            L.join(j),
                                            t.move(Object(A.u)(Math.random() * M.width, M.ground - t.sprite.height / 2)),
                                            O(M, t),
                                            M.add(t)
                                    }
                                    M.onCowKill = j => {
                                        ...
                                        t.position = j.position,
                                            ...
                                            setTimeout(() => M.groundObjects.delete(t), 30 * u.n),
                                            Object(x.a)(M, j),
                                            N.kills++
                                    }
                                        ;
